...
public class Cell
{
	...
	public boolean equals(Object obj)
	{
		...
		Cell other = (Cell) obj;
		boolean iconsEqual = icon == null && other.icon == null || icon.equals(other.icon);
		boolean positionsEqual = position == null && other.position == null || position.equals(other.position);
